import __farmNodeModule from 'node:module';globalThis.nodeRequire = __farmNodeModule.createRequire(import.meta.url);(globalThis || window || global)['5b4b38a5164bbcd577766aad3135d55f'] = {__FARM_TARGET_ENV__: 'node'};function _interop_require_default(obj) {
...
import * as __farm_external_module_path from "path";import * as __farm_external_module_util from "util";(globalThis || window || global)['5b4b38a5164bbcd577766aad3135d55f'].__farm_module_system__.setExternalModules({"path": __farm_external_module_path && __farm_external_module_path.default && !__farm_external_module_path.__esModule ? {...__farm_external_module_path,__esModule:true} : __farm_external_module_path,"util": __farm_external_module_util && __farm_external_module_util.default && !__farm_external_module_util.__esModule ? {...__farm_external_module_util,__esModule:true} : __farm_external_module_util});(function(_){for(var r in _){_[r].__farm_resource_pot__='index.js';(globalThis || window || global)['5b4b38a5164bbcd577766aad3135d55f'].__farm_module_system__.register(r,_[r])}})({"0129a2e3":function  (module, exports, farmRequire, farmDynamicRequire) {
    'use strict';
